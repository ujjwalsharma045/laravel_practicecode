...
<?php 
   echo Form::open(array('url' => 'user/index'));	
    ?>
	<div>
	  <?php 
...
<table style="border:1px solid #000000;" border="1" width="100%">
	...
	foreach($users as $user){
		...
		<tr>
		   ...
		   <td>
			  <?php echo CustomHelper::formatDate($user->created_at); ?>
		   </td>
		   <td>
		   ...
		   <td>
			  <a href="<?php echo URL::to('user/view/'.$user->id); ?>">
			    View
			  </a>
			  
			  <a href="<?php echo URL::to('user/edit/'.$user->id); ?>">
			    Edit
			  </a>
			  
			  <a href="<?php echo URL::to('user/remove/'.$user->id);?>">
			    Delete
			  </a>
		   </td>
		</tr>
